  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Your users are always in control of their non-custodial smart wallet.</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <div>
          <div className="flex items-center gap-2 mb-1">
            <p className="text-sm font-medium text-muted-foreground">Smart wallet address</p>
          </div>
            ...
            <Button
              ...
              onClick={() => {
                if (address && baseSepolia.blockExplorers?.default?.url) {
                  window.open(`${baseSepolia.blockExplorers.default.url}/address/${address}`, "_blank")
                }
              }}
            >
        ...
        {address && (
          <Card className="mt-4">
            <CardHeader>
              ...
              <CardDescription>Fund your smart wallet with some USDC.</CardDescription>
            </CardHeader>
            <CardContent>
              ...
              {fundingTxHash && (
                <div className="mt-4">
                  <p className="text-sm font-medium text-muted-foreground mb-1">Funding Transaction</p>
                  <div className="flex items-center gap-2">
                    <Badge variant="outline" className="font-mono text-xs py-1 px-2">
                    ...
                    <Button
                      ...
                      className="h-6 w-6"
                      onClick={() =>
                        window.open(`${baseSepolia.blockExplorers?.default.url}/tx/${fundingTxHash}`, "_blank")
                      }
                    >
                      <ExternalLink className="h-3.5 w-3.5" />
                    </Button>
        ...
        <Card className="mt-4">
          ...
          <CardContent className="space-y-4">
            {aiAgentAddress && (
              <div>
                <p className="text-sm font-medium text-muted-foreground mb-1">AI Agent Address</p>
                <div className="flex items-center gap-2">
                  <Badge variant="outline" className="font-mono text-xs py-1 px-2">
            ...
            {userOpHash && (
              <div>
                <p className="text-sm font-medium text-muted-foreground mb-1">UserOp Hash</p>
                <div className="flex items-center gap-2">
                  <Badge variant="outline" className="font-mono text-xs py-1 px-2">
                ...
                {!isPermitting && <p className="mt-1 text-green-600">Success! Session key registered.</p>}
                {isPermitting && <p className="mt-1">Waiting for the transaction to be mined...</p>}
              </div>
            )}
